...
# instruction path for Roman (my account is under a different directory)
INSTR_PATH=/home/grads/$1/capstone/phase_3/instrumentation.c
TARGET_OUT_PATH=/home/grads/$1/capstone/phase_3
...
cmake \
    ...
    -DCMAKE_EXE_LINKER_FLAGS="$INSTR_O_PATH -Wl,--wrap=main -Wl,--wrap=exit -lrt" \
    ../
